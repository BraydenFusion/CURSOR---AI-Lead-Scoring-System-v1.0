          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              >
                ...
                <p className="mt-1 text-xs text-slate-500">Max file size: 20 MB</p>
                <Input
                  type="file"
                  accept=".csv,.xlsx,.xls"
                  className="hidden"
              ...
              {selectedFile && (
                <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        {(selectedFile.size / 1024).toFixed(1)} KB • {detectedFormat?.toUpperCase()} detected
                      </p>
                    </div>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-xs text-slate-500">Required columns: {REQUIRED_COLUMNS.join(", ")}</p>
                    <div className="mt-2 flex flex-wrap gap-2">
                      {previewHeaders.length > 0 ? (
                        ...
                        <span className="text-xs text-slate-500">Column preview unavailable for this format.</span>
                      )}
                    </div>
                  </div>
                </div>
