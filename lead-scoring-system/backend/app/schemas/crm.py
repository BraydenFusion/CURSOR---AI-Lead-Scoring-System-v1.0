"""Schemas for CRM (Pipedrive) integrations."""
...
class PipedriveCredentials(BaseModel):
    api_token: str
    base_url: Optional[str] = Field(default=None, description="Optional override for Pipedrive API base URL.")


class PipedriveConnectRequest(CRMIntegrationBase):
